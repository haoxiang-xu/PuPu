...
import { reduceActivityTreeV4 } from "./activity_tree";
import { adaptActivityTreeToTraceChainV4 } from "./trace_chain_adapter";
...
const adaptEvents = (events) => {
  ...
  return adaptActivityTreeToTraceChainV4(
    reduceActivityTreeV4(null, store.getSnapshot()),
  );
};

describe("runtime event v4 TraceChain adapter", () => {
