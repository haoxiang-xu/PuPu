...
const runtimeEvent = ({
  ...
  type,
  seq = 1,
  runId = "run-runtime-root",
  agentId = "developer",
  turnId = "run-runtime-root:turn-1",
  links = {},
  ...
  type,
  timestamp,
  session_id: "thread-runtime-preview",
  run_id: runId,
  agent_id: agentId,
  turn_id: turnId,
  seq,
...
const RUNTIME_EVENTS_SCENARIO = {
  name: "Runtime Events",
  description: "Typed runtime events adapted into the existing TraceChain view",
  events: [
    runtimeEvent({
      id: "evt-runtime-session",
      type: "session.started",
      seq: 1,
      runId: "",
      turnId: null,
      payload: {
        thread_id: "thread-runtime-preview",
        model: "openai:gpt-5",
        trace_level: "minimal",
      },
    }),
    ...
    runtimeEvent({
      id: "evt-runtime-reasoning",
      type: "step.delta",
      seq: 3,
      payload: {
        step_id: "model:run-runtime-root:turn-1:reasoning",
    ...
    runtimeEvent({
      id: "evt-runtime-tool-start",
      type: "step.started",
      seq: 4,
      links: { step_id: "tool:call-runtime-1", tool_call_id: "call-runtime-1" },
      payload: {
        step_id: "tool:call-runtime-1",
        step_type: "tool",
    ...
    runtimeEvent({
      id: "evt-runtime-final",
      type: "step.completed",
      seq: 6,
      payload: {
        step_id: "model:run-runtime-root:turn-1:response",
        step_type: "model_response",
        status: "completed",
        final_text:
