...
BUILTIN_RULES = [
    ...
    "All file creation and modification must happen inside the user's workspace. Never write files outside the workspace unless the user explicitly provides an absolute path in their message.",
]
