...
**Plumbing:** follow the [shared board rules](../release-open-sprint/references/board-api.md) for
...
issue-refine-ticket for the recommended investigation and body shape.
