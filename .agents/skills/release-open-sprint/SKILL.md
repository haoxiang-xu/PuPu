...
**Plumbing:** read [board-api.md](references/board-api.md) first. Without project scope,
...
**Act 0 — data first.** Use the installed community-growth-analyst skill in light mode, reusing
...
issues/discussions, and the [topic optimizer verdict](../community-repo-tags-optimization/SKILL.md). One screen, business
language.
...
issue-draft-ticket with this Release parent as the target; it creates each
