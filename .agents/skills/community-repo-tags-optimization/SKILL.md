...
Iteratively optimize `haoxiang-xu/PuPu`'s GitHub topics with measurement, not taste. Companion to `community-growth-analyst` (traffic/download collection lives there — reuse its snapshots when today's already exist in `.claude/archive/growth/`).
