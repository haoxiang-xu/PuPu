...
**状态**: **历史迁移档案，已执行且已被后续规则取代。不得再次作为执行清单。** 2026-08-21 起 owner、Quorum、case 与庭审流程完全退役；当前入口只在根目录 `CLAUDE.md`、`AGENTS.md`、[`.claude/CLAUDE.md`](CLAUDE.md) 与对应 Release skill。

**2026-08-10 历史阶段提示**：本文后文关于 Track、motion/proposal、Speaker、owner、HS/RS、Debate 与 Full 的内容只解释当时制度，现已全部退役。本文件只保留迁移测量、角色来源与历史决策依据，不定义当前流程。
