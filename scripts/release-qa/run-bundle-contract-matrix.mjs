export const UNCHAIN_RUN_BUNDLE_TESTS = Object.freeze([
  ...
  "tests/test_run_bundle_ledger_runtime.py::test_materialize_compact_projection_on_run_bundle_canonical_limit",
  "tests/test_run_bundle_ledger_runtime.py::test_materialize_compact_projection_on_proactive_threshold",
  "tests/test_run_bundle_ledger_runtime.py::test_compact_projection_metric_events_roundtrip_with_persistence",
  "tests/test_run_bundle_ledger_runtime.py::test_compact_projection_preserves_child_bundle_facts_on_canonical_limit",
  "tests/test_run_bundle_ledger_runtime.py::test_compact_child_projection_details_are_hydrated_for_root_graph_replay",
  "tests/test_run_bundle_ledger_runtime.py::test_compact_projection_rejects_malformed_extension_on_replay",
...
export const PUPU_RUN_BUNDLE_TESTS = Object.freeze([
  ...
  "tests/test_run_bundle_adapter.py::test_projects_compact_v2_without_v1_fallback",
  ...
  "tests/test_run_bundle_ledger.py::test_reopen_recovers_compact_v2_without_v1_table_collision",
...
export const ELECTRON_RUN_BUNDLE_TESTS = Object.freeze([
  ...
  {
    file: "electron/tests/shared/run_bundle_v2.test.cjs",
    names: Object.freeze([
      "accepts a canonical summary with immutable details ref",
      "rejects a present-invalid v2 value without v1 fallback",
      "rejects a digest change",
    ]),
  },
  {
    ...
    names: Object.freeze([
      ...
      "stores and reloads compact v2 without constructing v1 slices",
    ]),
  },
]);
...
export const RENDERER_RUN_BUNDLE_TESTS = Object.freeze([
  {
    ...
    names: Object.freeze([
      ...
      "projects compact v2 aggregate usage without inline receipts",
    ]),
  },
  {
    ...
    names: Object.freeze([
      ...
      "rejects present malformed bundle claims",
